...
var render = function() {
  ...
  return _c(
    "modal",
    {
      attrs: {
        name: "new-project",
        classes: "bg-white rounded-lg shadow p-10",
        height: "auto"
      }
    },
    [
      _c("h1", { staticClass: "font-medium mb-16 text-center text-2xl" }, [
        ...
        [
          ...
          _c("footer", { staticClass: "flex justify-end" }, [
            _c(
              ...
              {
                staticClass:
                  "bg-white text-blue-400 border border-blue-400 rounded-lg shadow-lg text-sm py-3 px-4 mr-4",
                attrs: { type: "button" },
                on: {
                  click: function($event) {
            ...
            _c(
              ...
              {
                staticClass:
                  "bg-blue-400 text-white rounded-lg shadow-lg text-sm py-3 px-4"
              },
...
Vue.component('new-project', __webpack_require__(/*! ./components/NewProjectModal.vue */ "./resources/js/components/NewProjectModal.vue")["default"]);
...
__webpack_require__(/*! C:\xampp\htdocs\Laravel\birdboard\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\xampp\htdocs\Laravel\birdboard\resources\css\app.css */"./resources/css/app.css");
