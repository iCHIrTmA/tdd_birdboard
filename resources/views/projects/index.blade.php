...
<modal name="hello-world" classes="bg-white rounded-lg shadow p-10" height=auto>
	<h1 class="font-medium mb-16 text-center text-2xl">Let's Start Something New</h1>
	...
	<footer class="flex justify-end">
		<button class="bg-white text-blue-400 border border-blue-400 rounded-lg shadow-lg text-sm py-3 px-4 mr-4">Cancel</button>
		<button class="bg-blue-400 text-white rounded-lg shadow-lg text-sm py-3 px-4">Create Project</button>
	</footer>
</modal>
